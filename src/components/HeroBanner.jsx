...
export default function HeroBanner({ videos, onPlay }) {
  ...
  return (
    <div className="relative w-full h-[70vh] min-h-[500px] flex items-center bg-[#0a0a0a] overflow-hidden">
      ...
      <div className="relative z-10 px-8 md:px-16 max-w-7xl w-full mx-auto text-white">
        <h1 className="text-4xl md:text-6xl font-extrabold mb-4 leading-tight tracking-tight max-w-2xl">
          {currentVideo.title}
        </h1>
        ...
        <p className="text-[#c3c3c3] text-sm md:text-base mb-8 line-clamp-3 leading-relaxed max-w-xl">
        ...
        <div className="flex gap-4">
          <button 
            ...
            className="bg-[#f47521] hover:bg-[#df6516] text-black font-bold py-3 px-8 rounded-sm flex items-center gap-2 transition-all uppercase text-sm tracking-widest"
          >
